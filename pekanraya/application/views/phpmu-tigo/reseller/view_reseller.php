<p class='sidebar-title block-title'>Daftar Semua Pelapak</p>
  <?php 
    ...
    echo "<div class='col-md-2 col-xs-6' style='margin-bottom:20px'>
              ...
              ";
              if($row[verified]=='Y') { 
                $status = "<img src='http://localhost/market/asset/images/verif.png' width='20px' title='Terverifikasi'>"; 
              }
              ...
              if ($this->session->produk == ''){
                ...
                echo "<a title='Lihat Produk' href='".base_url()."$akses/produk_reseller/$row[id_reseller]'> <b>$row[nama_reseller]  </b>$status<br></a>";
              }else{
                ...
                echo "<a title='Lihat Produk' href='".base_url()."$akses/keranjang/$row[id_reseller]'> <b>$row[nama_reseller]</b><br></a>";
              }
              echo "$row[tipe_member]<br>";
              echo "<span>$kota</span><br>";
              echo "</center>
          </div>";
      $no++;
    }
