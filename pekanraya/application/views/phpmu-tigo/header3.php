...
echo "</ul>";
?>
<?php echo "<a class='allProduct' href='".base_url()."produk'><b>Semua</b> Produk <i class='fa fa-angle-right'></i></a>" ?>
</div>
</div></div>
</div>
</div>
...
<form action='/produk/index' id='search_mini_form'>
<?php form_open('produk/index') ?>
