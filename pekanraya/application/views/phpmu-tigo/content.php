...
echo "<div class='paragraph-row hidden-xs'>
	...
	<div class='column2' style='margin-left: 1%'>
		<a href='".base_url()."voucher/'><img src='".base_url()."asset/foto_iklanatas/$ik5[gambar]' style='width:100%; min-height: 380px;'></a>
	</div>
</div>
<br>";
	    ...
	    echo "<div class='produk col-md-2 col-xs-6'>
	              <center>
	                ...
	                <div style='height:140px; overflow:hidden'>
	                  <a title='$row[nama_produk]' href='".base_url()."produk/detail/$row[id_produk]/$row[produk_seo]'><img style=' min-height:140px; width:100%' src='".base_url()."asset/foto_produk/$foto_produk'></a>
	                  		$diskon_persen
	                </div>
	                <h4 class='produk-title'><a title='$row[nama_produk]' href='".base_url()."produk/detail/$row[id_produk]/$row[produk_seo]'>$judul</a></h4>
