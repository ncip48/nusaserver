<p class='sidebar-title text-danger produk-title'>Data Pelapak</p>
  ...
  <tbody>
    ...
    <tr><th scope='row' width='140px'>Nama Pelapak</th> <td><?php echo $rows['nama_reseller']; if($rows['verified']=='Y') { 
                echo "   <img src='http://localhost/market/asset/images/verif.png' width='20px' title='Terverifikasi'>"; 
              }?></td></tr>
    <tr><th scope='row' width='140px'>Status Verifikasi</th> <td><?php if($rows['verified']=='Y') { 
                echo "Terverifikasi"; 
              }else{
                echo "Belum Terverifikasi";
              } ?></td></tr>
    <tr><th scope='row' width='140px'>Tipe Member</th> <td><?php echo $rows['tipe_member']?></td></tr>
    ...
    <tr><th scope='row'>Landingpage</th> <td><?php echo "<a href='".base_url()."landingpage/details/".$this->uri->segment(3)."'>Link</a>" ?></td></tr>
    <!-- <tr><th scope='row'>Keterangan</th> <td><?php echo $rows['keterangan']?></td></tr> -->
  </tbody>
  </table>
  <hr>

  <p class='sidebar-title text-danger produk-title'>Produk Pelapak</p>
