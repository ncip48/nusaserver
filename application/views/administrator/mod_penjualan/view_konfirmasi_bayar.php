                            ...
                            <table id="example1" class='table table-hover table-condensed'>
                              ...
                              <tbody>
                                <?php 
                                  ...
                                  echo "<tr><td>$no</td>
                                            <td><a href='".base_url()."administrator/tracking/$row[no_tagihan]'>$row[no_tagihan]</a></td>
                                            <td style='color:red;'>$row[total_transfer]</td>
                                            <td>$row[nama_pengirim]</td>
                                            <td>$row[nama_bank]</td>
                                            <td>".tgl_indo($row['tanggal_transfer'])."</td>
                                            <td width='50px'><a class='btn btn-info btn-xs' title='Detail data pesanan' href='".base_url()."administrator/tracking/$row[no_tagihan]'><span class='glyphicon glyphicon-search'></span></a></td>
                                         </tr>";
                                    $no++;
                                  }
                                ?>
