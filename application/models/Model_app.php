...
class Model_app extends CI_model{
    ...
    function profile_konsumen($id){
        return $this->db->query("SELECT a.kode_konfirmasi, a.id_konsumen, a.username, a.nama_lengkap, a.email, a.jenis_kelamin, a.tanggal_lahir, a.tempat_lahir, a.alamat_lengkap, a.no_hp, a.tanggal_daftar, a.foto, b.kota_id, b.nama_kota as kota FROM `rb_konsumen` a LEFT JOIN rb_kota b ON a.kota_id=b.kota_id where a.id_konsumen='$id'");
    }
}