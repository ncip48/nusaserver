<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/edit_supervisor',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$record[id_supervisor]'>
                    ...
                    <tr><th scope='row'>Nama Staff</th><td><input type='text' class='form-control' name='c' value='$record[nama]'></td></tr>
