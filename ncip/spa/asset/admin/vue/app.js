...
var v = new Vue({
   el:'#app',
    ...
    methods:{
         tampil(){ axios.get(this.url+"administrator/tampil_survey").then(function(response){
          ...
          caribiodata(){
            var formData = v.formData(v.search);
              axios.post(this.url+"administrator/cari_survey", formData).then(function(response){
                  if(response.data.biodata == null){
                      v.noResult()
                    }else{
                      v.getData(response.data.biodata);
